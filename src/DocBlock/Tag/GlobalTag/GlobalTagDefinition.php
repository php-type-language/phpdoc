 ...
 * ```
 */
final class GlobalTagDefinition extends TagDefinition
{
    ...
    public function create(string $name, TagPayload $result): GlobalTag
    {
        ...
        return new GlobalTag($name, $type, $variable, $description);
    }
}
